\begin{homeworkProblem}
  ...
  \begin{solucion}
    ...
    \begin{align*}
      ...
      &|B(o,1)| \int_{-\frac{1}{4\pi}}^{0} \int_{0}^{\sqrt{2nslog(-4\pi s)}} \frac{r^{n-1}}{s^{2}} drds\\ 
      &= \frac{|B(o,1)|}{n+2} \int_{-\frac{1}{4\pi}}^{0} \frac{(2nslog(-4\pi s)^{\frac{n}{2}})}{s^{2}} drds\\
      &= \frac{|B(o,1)|}{n+2} \int_{0}^{\frac{1}{4\pi}} \frac{(2nslog(4\pi s)^{\frac{n}{2}})}{s^{2}} drds\\
      &= \frac{|B(o,1)|(2n)^{\frac{n}{2}+1}}{n+2} \int_{0}^{\frac{1}{4\pi}} s^{\frac{n}{2}} (log(4\pi s))^{\frac{n}{2}+1}drds
    \end{align*}
    \demostrado
  \end{solucion}  
\end{homeworkProblem}
